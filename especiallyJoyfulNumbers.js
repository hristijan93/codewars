...
function numberJoy(n) {
    let nNumbers = String(n).split(``)
    let nSum = nNumbers.reduce((a, s) => +a + +s, 0)
    let nSumReversed = +String(nSum).split(``).reverse().join(``)

    return nSum * nSumReversed == n
}

console.log(numberJoy(1729));
console.log(numberJoy(25));
*/